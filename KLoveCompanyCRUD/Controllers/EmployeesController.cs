...
namespace KLoveCompanyCRUD.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(KLoveCompanyCRUDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DepartmentId,FirstName,LastName,AddressLine1,AddressLine2,City,State,Zip,Email1,Email2")] Employee employee)
        {
